...
void main() {
  ...
  group('DashbotActiveRouteNotifier', () {
    ...
    test(
      'resetToBaseRoute() unpins chat and recalculates from current request',
      () {
        const requestWithResponse = RequestModel(
          id: '1',
          name: 'Test Request',
    ...
    test('request changes are reflected when chat is not pinned', () {
      ...
      final requestProvider = StateProvider<RequestModel?>(
        (ref) => requestWithoutResponse,
      );
