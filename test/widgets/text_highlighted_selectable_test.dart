...
void main() {
  testWidgets('HighlightedSelectableText renders plain text when no query', (
    ...
    await tester.pumpWidget(
      const MaterialApp(
        home: Scaffold(body: HighlightedSelectableText(text: 'Hello World')),
      ),
    );
  ...
  testWidgets('HighlightedSelectableText renders plain text when empty query', (
    ...
    await tester.pumpWidget(
      const MaterialApp(
        home: Scaffold(
          body: HighlightedSelectableText(text: 'Hello World', query: ''),
        ),
      ),
    );
  ...
  testWidgets('HighlightedSelectableText is case insensitive', (tester) async {
    await tester.pumpWidget(
      const MaterialApp(
        home: Scaffold(
          body: HighlightedSelectableText(text: 'Hello World', query: 'HELLO'),
        ),
      ),
    );
