...
void main() {
  ...
  testWidgets('Testing Sidebar Environment Card onSecondaryTapUp', (tester) async {
    ...
    final gesture = await tester.startGesture(tester.getCenter(card), buttons: kSecondaryButton);
    await tester.pump();
    await gesture.up();
    await tester.pumpAndSettle();
