...
void main() {
  testWidgets('Testing Sending Widget Without Timer', (tester) async {
    await tester.pumpWidget(
      MaterialApp(
        ...
        home: const Scaffold(body: SendingWidget(startSendingTime: null)),
      ),
    );
  ...
  testWidgets('Testing Sending Widget With Timer', (tester) async {
    await tester.pumpWidget(
      MaterialApp(
        title: 'Send',
        theme: kThemeDataDark,
        home: Scaffold(body: SendingWidget(startSendingTime: DateTime.now())),
      ),
    );
  ...
  testWidgets('Testing Not Sent Widget', (tester) async {
    await tester.pumpWidget(
      const MaterialApp(
        title: 'Not Sent',
        home: Scaffold(body: NotSentWidget()),
      ),
    );
  ...
  testWidgets('Testing Response Body, no data sent', (tester) async {
    ...
    expect(
      find.text('Error: Response data does not exist. $kUnexpectedRaiseIssue'),
      findsOneWidget,
    );
  });
      ...
      MaterialApp(
        ...
        home: Scaffold(
          body: ResponseBodySuccess(
            body: 'Hello from API Dash',
            mediaType: MediaType("application", "json"),
            options: const [ResponseBodyView.raw],
            bytes: Uint8List.fromList([20, 8]),
          ),
        ),
      ),
...
''';
      ...
      MaterialApp(
        ...
        home: Scaffold(
          body: ResponseBodySuccess(
            ...
            formattedBody: code,
            mediaType: MediaType("application", "json"),
            options: const [ResponseBodyView.code],
            bytes: Uint8List.fromList([20, 8]),
      ...
      MaterialApp(
        ...
        home: Scaffold(
          body: ResponseBodySuccess(
            ...
            options: const [ResponseBodyView.preview],
        ...
        MaterialApp(
          ...
          home: Scaffold(
            body: ResponseBodySuccess(
              ...
              mediaType: MediaType("application", "json"),
              options: const [ResponseBodyView.code, ResponseBodyView.raw],
              bytes: kBodyBytesJpeg,
  ...
  testWidgets('Testing Body Success for ResponseBodyView.answer', (
    tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
        ...
        home: Scaffold(
          body: ResponseBodySuccess(
            ...
            options: const [ResponseBodyView.answer],
      ...
      MaterialApp(
        ...
        home: Scaffold(
          body: ResponseBodySuccess(
            ...
            options: const [ResponseBodyView.sse],
            bytes: Uint8List.fromList([]),
  ...
  testWidgets(
    'Testing Body Success for ResponseBodyView.raw with isAIResponse',
    (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          title: 'Body Success',
