...
void main() {
  ...
  testWidgets(
    'EnvironmentPopupMenu displays "None" when no value is provided',
  ...
  testWidgets(
    'EnvironmentPopupMenu displays "Select Env." when value is null',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(body: EnvironmentPopupMenu(value: null, options: [])),
        ),
      );
