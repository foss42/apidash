...
$ g++ <filename>.cpp -lcurl -o <executable-name>
*/
...
int main() {
  ...
  CURLcode res;
  if(curl) {
    curl_easy_setopt(curl, CURLOPT_URL, "https://api.foss42.com/country/data");
    curl_easy_setopt(curl, CURLOPT_CUSTOMREQUEST, "GET");
...
int main() {
  ...
  CURLcode res;
  if(curl) {
    curl_easy_setopt(curl, CURLOPT_URL, "https://api.foss42.com/country/data?code=US");
    curl_easy_setopt(curl, CURLOPT_CUSTOMREQUEST, "GET");
...
int main() {
  ...
  CURLcode res;
  if(curl) {
    curl_easy_setopt(curl, CURLOPT_URL, "https://api.foss42.com/humanize/social");
    curl_easy_setopt(curl, CURLOPT_CUSTOMREQUEST, "GET");
...
int main() {
  ...
  CURLcode res;
  if(curl) {
    curl_easy_setopt(curl, CURLOPT_URL, "http://api.foss42.com");
    curl_easy_setopt(curl, CURLOPT_CUSTOMREQUEST, "HEAD");
...
int main() {
  ...
  CURLcode res;
  if(curl) {
    curl_easy_setopt(curl, CURLOPT_URL, "https://api.foss42.com/case/lower");
