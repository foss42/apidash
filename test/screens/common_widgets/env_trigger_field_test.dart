...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      fieldKey.currentState!.controller.selection = TextSelection.collapsed(
        offset: 5,
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      fieldKey.currentState!.controller.selection = TextSelection(
        baseOffset: 0,
        extentOffset: 5,
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        fieldKey.currentState!.controller.selection.baseOffset,
        newValue.length,
      );
