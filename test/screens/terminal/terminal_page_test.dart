...
void main() {
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final networkTitle = find.byWidgetPredicate(
        (w) =>
            w is RichText &&
      ...
      final menuWidget = tester.widget<TerminalLevelFilterMenu>(
        find.byType(TerminalLevelFilterMenu),
      );
  ...
  testWidgets('search highlighting works across different tile types', (
    ...
    term.completeNetwork(
      netId,
      statusCode: 200,
      responseBodyPreview: '{"test": "success"}',
    );
