...
void main() {
  const sm = SettingsModel(
    ...
    connectionTimeout: kDefaultConnectionTimeout,
  );
  ...
  test('Testing toString()', () {
    const expectedResult =
        "{isDark: false, alwaysShowCollectionPaneScrollbar: true, width: 300.0, height: 200.0, dx: 100.0, dy: 150.0, defaultUriScheme: http, defaultCodeGenLang: curl, saveResponses: true, promptBeforeClosing: true, connectionTimeout: 300000}";
