...
const requestModelGet1 = RequestModel(
  ...
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelGet1),
);
...
const requestModelGet2 = RequestModel(
  id: 'get2',
  apiType: APIType.rest,
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelGet2),
);
...
const requestModelGet3 = RequestModel(
  id: 'get3',
  apiType: APIType.rest,
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelGet3),
);
...
const requestModelGet4 = RequestModel(
  id: 'get4',
  apiType: APIType.rest,
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelGet4),
);
...
const requestModelGet5 = RequestModel(
  id: 'get5',
  apiType: APIType.rest,
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelGet5),
);
...
const requestModelGet6 = RequestModel(
  id: 'get6',
  apiType: APIType.rest,
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelGet6),
);
...
const requestModelGet7 = RequestModel(
  id: 'get7',
  apiType: APIType.rest,
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelGet7),
);
...
const requestModelGet8 = RequestModel(
  id: 'get8',
  apiType: APIType.rest,
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelGet8),
);
...
const requestModelGet9 = RequestModel(
  id: 'get9',
  apiType: APIType.rest,
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelGet9),
);
...
const requestModelGet10 = RequestModel(
  id: 'get10',
  apiType: APIType.rest,
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelGet10),
);
...
const requestModelGet11 = RequestModel(
  id: 'get11',
  apiType: APIType.rest,
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelGet11),
);
...
const requestModelGet12 = RequestModel(
  id: 'get12',
  apiType: APIType.rest,
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelGet12),
);
...
const requestModelHead1 = RequestModel(
  id: 'head1',
  apiType: APIType.rest,
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelHead1),
);
...
const requestModelHead2 = RequestModel(
  id: 'head2',
  apiType: APIType.rest,
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelHead2),
);
...
const requestModelPost1 = RequestModel(
  id: 'post1',
  apiType: APIType.rest,
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelPost1),
);
...
const requestModelPost2 = RequestModel(
  id: 'post2',
  apiType: APIType.rest,
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelPost2),
);
...
const requestModelPost3 = RequestModel(
  id: 'post3',
  apiType: APIType.rest,
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelPost3),
);
...
const requestModelPost4 = RequestModel(
  id: 'post4',
  apiType: APIType.rest,
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelPost4),
);
...
const requestModelPost5 = RequestModel(
  id: 'post5',
  apiType: APIType.rest,
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelPost5),
);
...
const requestModelPost6 = RequestModel(
  id: 'post6',
  apiType: APIType.rest,
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelPost6),
);
...
const requestModelPost7 = RequestModel(
  id: 'post7',
  apiType: APIType.rest,
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelPost7),
);
...
const requestModelPost8 = RequestModel(
  id: 'post8',
  apiType: APIType.rest,
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelPost8),
);
...
const requestModelPost9 = RequestModel(
  id: 'post9',
  apiType: APIType.rest,
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelPost9),
);

const requestModelPost10 = RequestModel(
  id: 'post9',
  apiType: APIType.rest,
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelPost10),
);
...
const requestModelPut1 = RequestModel(
  id: 'put1',
  apiType: APIType.rest,
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelPut1),
);
...
const requestModelPatch1 = RequestModel(
  id: 'patch1',
  apiType: APIType.rest,
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelPatch1),
);
...
const requestModelDelete1 = RequestModel(
  id: 'delete1',
  apiType: APIType.rest,
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelDelete1),
);
...
const requestModelDelete2 = RequestModel(
  id: 'delete2',
  apiType: APIType.rest,
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelDelete2),
);
...
const requestModelGet13 = RequestModel(
  id: 'get13',
  apiType: APIType.rest,
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelGet13),
);
...
const requestModelGetBadSSL = RequestModel(
  id: 'badSSL',
  apiType: APIType.rest,
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelGetBadSSL),
);
...
const requestModelPost11 = RequestModel(
  id: 'post11',
  apiType: APIType.rest,
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelPost11),
);
...
const requestModelPost12 = RequestModel(
  id: 'post12',
  apiType: APIType.rest,
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelPost12),
);
...
const requestModelPost13 = RequestModel(
  id: 'post13',
  apiType: APIType.rest,
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelPost13),
);

const requestModelOptions1 = RequestModel(
  id: 'options1',
  apiType: APIType.rest,
  protocolModel: ProtocolModel.rest(httpRequestModel: httpRequestModelOptions1),
);
