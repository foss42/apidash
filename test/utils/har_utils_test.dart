...
void main() {
  group("Testing HAR Utils", () {
    ...
    test('Test requestModelToHARJsonRequest', () {
      ...
      expect(
        requestModelToHARJsonRequest(requestModelGet6.httpRequestModel),
        expectedResult,
      );
    });
    ...
    test('Test requestModelToHARJsonRequest useEnabled=false', () {
      ...
      expect(
        requestModelToHARJsonRequest(requestModelGet11.httpRequestModel),
        expectedResult,
      );
    });
    ...
    test('Test requestModelToHARJsonRequest with form data and exportMode', () {
      ...
      final result = requestModelToHARJsonRequest(
        requestModel,
        exportMode: true,
