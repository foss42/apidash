...
void main() {
  ...
  group("Testing File Utils", () {
    ...
    test(
      'getFileDownloadpath with existing file creates numbered suffix',
      () async {
    ...
    test('getApplicationSupportDirectoryFilePath returns valid path', () async {
      final path = await getApplicationSupportDirectoryFilePath(
        'appfile',
        'log',
      );
      expect(path, isNotNull);
    ...
    test(
      'getApplicationSupportDirectoryFilePath with existing file creates numbered suffix',
      () async {
        final path = await getApplicationSupportDirectoryFilePath(
          'appfile_exist',
          'log',
        ...
        final path2 = await getApplicationSupportDirectoryFilePath(
          'appfile_exist',
          'log',
        );
