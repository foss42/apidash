...
Future<void> runMobileHisIntegrationTest() async {
  apidashWidgetTest(
    "Testing History of Requests in mobile end-to-end",
    WindowWidth.compact.value,
    (WidgetTester tester, helper) async {
      ...
      final initSidebarCardCount = tester
          .widgetList<SidebarHistoryCard>(sidebarCards)
          .length;
      ...
      final initHistoryCardCount = tester
          .widgetList<HistoryRequestCard>(historyCards)
          .length;
      ...
      final newSidebarCardCount = tester
          .widgetList<SidebarHistoryCard>(sidebarCards)
          .length;
      kHisScaffoldKey.currentState!.closeDrawer();
      ...
      final newHistoryCardCount = tester
          .widgetList<HistoryRequestCard>(historyCards)
          .length;
      await tester.tapAt(const Offset(100, 100));
      await tester.pumpAndSettle();
