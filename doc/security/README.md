...
1. Review our [Security Policy](https://github.com/foss42/apidash/blob/main/SECURITY.md) for vulnerability reporting
2. Follow coordinated disclosure guidelines in the IRP
3. Report security issues through GitHub Security Advisories
...
- Contact maintainers via Discord #gsoc-foss-apidash channel

## Contributing to Security

We welcome contributions to improve API Dash security:

1. **Report Vulnerabilities**: Follow responsible disclosure in [SECURITY.md](https://github.com/foss42/apidash/blob/main/SECURITY.md)
...
- Follow [secure coding guidelines](https://owasp.org/www-project-secure-coding-practices-quick-reference-guide/stable-en/02-checklist/05-checklist.html)
