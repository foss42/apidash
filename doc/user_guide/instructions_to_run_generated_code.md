...
Create a folder and initialize module:
...
Create a file named `main.go` and paste the code generated by API Dash into it.
...
This will execute the API request generated by API Dash.
