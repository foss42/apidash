...
class EditRequestBody extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    void changeToPostMethod() {
      if(ref.read(collectionStateNotifierProvider.notifier).getRequestModel(selectedId)?.httpRequestModel!.method != HTTPVerb.get) {
        ref
            .read(collectionStateNotifierProvider.notifier)
            .update(selectedId, forcedGETRequestMethod: false);
      }
      if (ref.read(collectionStateNotifierProvider.notifier).getRequestModel(selectedId)?.httpRequestModel!.method == HTTPVerb.get && !ref.read(collectionStateNotifierProvider.notifier).getRequestModel(selectedId)!.forcedGETRequestMethod) {
        ref
            .read(collectionStateNotifierProvider.notifier)
