...
//     // Watch header length to trigger rebuilds when headers change
//     ref.watch(selectedRequestModelProvider
//         .select((value) => value?.httpRequestModel?.headers?.length));

//     final apiType = ref.read(selectedRequestModelProvider)?.apiType;

//     // Determine headers and `isHeaderEnabledList` based on `apiType`
//     late List<NameValueModel>? rH;
//     late List<bool>? rEnabledList;
...
//     // Initialize `headerRows`
//     final bool isHeadersEmpty = rH == null || rH.isEmpty;
//     headerRows = isHeadersEmpty
//         ? [kNameValueEmptyModel]
//         : rH + [kNameValueEmptyModel];

//     // Initialize `isRowEnabledList`
//     isRowEnabledList = [
//       ...(rEnabledList ??
//           List.filled(rH?.length ?? 0, true, growable: true)),
//     ];
