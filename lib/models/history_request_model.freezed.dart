...
mixin _$HistoryRequestModel {
 ...
 String get historyId; HistoryMetaModel get metaData; HttpRequestModel? get httpRequestModel; AIRequestModel? get aiRequestModel; WebSocketRequestModel? get wsRequestModel; MQTTRequestModel? get mqttRequestModel; HttpResponseModel? get httpResponseModel; String? get preRequestScript; String? get postRequestScript; AuthModel? get authModel;
/// Create a copy of HistoryRequestModel
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$HistoryRequestModelCopyWith<HistoryRequestModel> get copyWith => _$HistoryRequestModelCopyWithImpl<HistoryRequestModel>(this as HistoryRequestModel, _$identity);
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,historyId,metaData,httpRequestModel,aiRequestModel,wsRequestModel,mqttRequestModel,httpResponseModel,preRequestScript,postRequestScript,authModel);

@override
String toString() {
  return 'HistoryRequestModel(historyId: $historyId, metaData: $metaData, httpRequestModel: $httpRequestModel, aiRequestModel: $aiRequestModel, wsRequestModel: $wsRequestModel, mqttRequestModel: $mqttRequestModel, httpResponseModel: $httpResponseModel, preRequestScript: $preRequestScript, postRequestScript: $postRequestScript, authModel: $authModel)';
}
...
@useResult
$Res call({
 String historyId, HistoryMetaModel metaData, HttpRequestModel? httpRequestModel, AIRequestModel? aiRequestModel, WebSocketRequestModel? wsRequestModel, MQTTRequestModel? mqttRequestModel, HttpResponseModel? httpResponseModel, String? preRequestScript, String? postRequestScript, AuthModel? authModel
});


$HistoryMetaModelCopyWith<$Res> get metaData;$HttpRequestModelCopyWith<$Res>? get httpRequestModel;$AIRequestModelCopyWith<$Res>? get aiRequestModel;$WebSocketRequestModelCopyWith<$Res>? get wsRequestModel;$MQTTRequestModelCopyWith<$Res>? get mqttRequestModel;$HttpResponseModelCopyWith<$Res>? get httpResponseModel;$AuthModelCopyWith<$Res>? get authModel;
...
/// Create a copy of HistoryRequestModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? historyId = null,Object? metaData = null,Object? httpRequestModel = freezed,Object? aiRequestModel = freezed,Object? wsRequestModel = freezed,Object? mqttRequestModel = freezed,Object? httpResponseModel = freezed,Object? preRequestScript = freezed,Object? postRequestScript = freezed,Object? authModel = freezed,}) {
...
as MQTTRequestModel?,httpResponseModel: freezed == httpResponseModel ? _self.httpResponseModel : httpResponseModel // ignore: cast_nullable_to_non_nullable
...
@override
@pragma('vm:prefer-inline')
$WebSocketRequestModelCopyWith<$Res>? get wsRequestModel {
    if (_self.wsRequestModel == null) {
    return null;
  }
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _HistoryRequestModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _HistoryRequestModel value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _HistoryRequestModel value)?  $default,){
final _that = this;
switch (_that) {
case _HistoryRequestModel() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String historyId,  HistoryMetaModel metaData,  HttpRequestModel? httpRequestModel,  AIRequestModel? aiRequestModel,  WebSocketRequestModel? wsRequestModel,  MQTTRequestModel? mqttRequestModel,  HttpResponseModel? httpResponseModel,  String? preRequestScript,  String? postRequestScript,  AuthModel? authModel)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _HistoryRequestModel() when $default != null:
return $default(_that.historyId,_that.metaData,_that.httpRequestModel,_that.aiRequestModel,_that.wsRequestModel,_that.mqttRequestModel,_that.httpResponseModel,_that.preRequestScript,_that.postRequestScript,_that.authModel);case _:
  return orElse();
...
class _HistoryRequestModel implements HistoryRequestModel {
  const _HistoryRequestModel({required this.historyId, required this.metaData, this.httpRequestModel, this.aiRequestModel, this.wsRequestModel, this.mqttRequestModel, this.httpResponseModel, this.preRequestScript, this.postRequestScript, this.authModel});
...
@pragma('vm:prefer-inline')
_$HistoryRequestModelCopyWith<_HistoryRequestModel> get copyWith => __$HistoryRequestModelCopyWithImpl<_HistoryRequestModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$HistoryRequestModelToJson(this, );
}
...
/// @nodoc
abstract mixin class _$HistoryRequestModelCopyWith<$Res> implements $HistoryRequestModelCopyWith<$Res> {
...
@override $HistoryMetaModelCopyWith<$Res> get metaData;@override $HttpRequestModelCopyWith<$Res>? get httpRequestModel;@override $AIRequestModelCopyWith<$Res>? get aiRequestModel;@override $WebSocketRequestModelCopyWith<$Res>? get wsRequestModel;@override $MQTTRequestModelCopyWith<$Res>? get mqttRequestModel;@override $HttpResponseModelCopyWith<$Res>? get httpResponseModel;@override $AuthModelCopyWith<$Res>? get authModel;
...
/// Create a copy of HistoryRequestModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? historyId = null,Object? metaData = null,Object? httpRequestModel = freezed,Object? aiRequestModel = freezed,Object? wsRequestModel = freezed,Object? mqttRequestModel = freezed,Object? httpResponseModel = freezed,Object? preRequestScript = freezed,Object? postRequestScript = freezed,Object? authModel = freezed,}) {
