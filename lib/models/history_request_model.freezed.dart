...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,historyId,metaData,httpRequestModel,aiRequestModel,wsRequestModel,mqttRequestModel,grpcRequestModel,httpResponseModel,preRequestScript,postRequestScript,authModel);

@override
String toString() {
  return 'HistoryRequestModel(historyId: $historyId, metaData: $metaData, httpRequestModel: $httpRequestModel, aiRequestModel: $aiRequestModel, wsRequestModel: $wsRequestModel, mqttRequestModel: $mqttRequestModel, grpcRequestModel: $grpcRequestModel, httpResponseModel: $httpResponseModel, preRequestScript: $preRequestScript, postRequestScript: $postRequestScript, authModel: $authModel)';
}
...
as MQTTRequestModel?,grpcRequestModel: freezed == grpcRequestModel ? _self.grpcRequestModel : grpcRequestModel // ignore: cast_nullable_to_non_nullable
as GrpcRequestModel?,httpResponseModel: freezed == httpResponseModel ? _self.httpResponseModel : httpResponseModel // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _HistoryRequestModel() when $default != null:
return $default(_that.historyId,_that.metaData,_that.httpRequestModel,_that.aiRequestModel,_that.wsRequestModel,_that.mqttRequestModel,_that.grpcRequestModel,_that.httpResponseModel,_that.preRequestScript,_that.postRequestScript,_that.authModel);case _:
  return orElse();
...
class _HistoryRequestModel implements HistoryRequestModel {
  const _HistoryRequestModel({required this.historyId, required this.metaData, this.httpRequestModel, this.aiRequestModel, this.wsRequestModel, this.mqttRequestModel, this.grpcRequestModel, this.httpResponseModel, this.preRequestScript, this.postRequestScript, this.authModel});
