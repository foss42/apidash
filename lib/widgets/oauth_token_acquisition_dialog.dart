...
class OAuthTokenAcquisitionDialog extends ConsumerStatefulWidget {
  ...
  const OAuthTokenAcquisitionDialog({super.key, this.initialConfig});
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
        ...
        children: [
          DropdownButtonFormField<OAuthConfig>(
            ...
            items: configs
                ...
                .toList(),
            onChanged: _isLoading ? null : (config) => setState(() => _selectedConfig = config),
      ...
      actions: [
        ...
        ElevatedButton(
          onPressed: _selectedConfig == null || _isLoading ? null : _acquireToken,
          child: _isLoading 
