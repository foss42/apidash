    ...
    try {
      ...
      if (uri != null) {
        ...
        result += templateStartUrl.render({
          ...
          'hasJsonBody':
              (requestModel.requestBodyContentType == ContentType.json)
        });
        ...
        if (headersList != null || hasBody) {
          ...
          if (headers.isNotEmpty || hasBody) {
            ...
            result += templateHeaders.render({"headers": headersString,"jsonisthere": hasJsonBody});
          }
        }
        if (requestModel.isFormDataRequest) {
