...
void main() {
  group('Basic HTTP Methods', () {
    test('GET request', () {
      ...
      expect(curl.toCurlString(), 'curl "https://api.apidash.dev"');
    });
    ...
    test('HEAD request', () {
      ...
      expect(curl.toCurlString(), 'curl -I "https://api.apidash.dev"');
    });
  });
  ...
  group('Headers and Data', () {
    test('request with headers', () {
      ...
      expect(curl.toCurlString(), r'''curl "https://api.apidash.dev" \
    ...
    test('request with form data', () {
      final curl = Curl(
        ...
        formData: [
          ...
          FormDataModel(name: "token", value: "123", type: FormDataType.text),
        ],
      );
      expect(
        curl.toCurlString(),
 ...
 -F "token=123"''',
    ...
    test('form defaults header when absent', () {
      ...
      expect(
        parsed.headers?[kHeaderContentType] ?? parsed.headers?['content-type'],
        'multipart/form-data',
      );
    });
  });
 ...
 -A 'MyApp/1.0'""");
    ...
    test('request with insecure flag', () {
      ...
      expect(curl.toCurlString(), r"""curl "https://api.apidash.dev" -k""");
    });
    ...
    test('request with location flag', () {
      ...
      expect(curl.toCurlString(), r"""curl "https://api.apidash.dev" -L""");
    });
  });
