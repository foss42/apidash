...
@useResult
$Res call({
 HTTPVerb method, String url, List<NameValueModel>? headers, List<NameValueModel>? params, AuthModel? authModel, List<bool>? isHeaderEnabledList, List<bool>? isParamEnabledList, ContentType bodyContentType, String? body, String? query, List<FormDataModel>? formData, String? bodyFile
});
...
as List<FormDataModel>?,bodyFile: freezed == bodyFile ? _self.bodyFile : bodyFile // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
/// Create a copy of HttpRequestModel
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( HTTPVerb method,  String url,  List<NameValueModel>? headers,  List<NameValueModel>? params,  AuthModel? authModel,  List<bool>? isHeaderEnabledList,  List<bool>? isParamEnabledList,  ContentType bodyContentType,  String? body,  String? query,  List<FormDataModel>? formData,  String? bodyFile)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _HttpRequestModel() when $default != null:
return $default(_that.method,_that.url,_that.headers,_that.params,_that.authModel,_that.isHeaderEnabledList,_that.isParamEnabledList,_that.bodyContentType,_that.body,_that.query,_that.formData,_that.bodyFile);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( HTTPVerb method,  String url,  List<NameValueModel>? headers,  List<NameValueModel>? params,  AuthModel? authModel,  List<bool>? isHeaderEnabledList,  List<bool>? isParamEnabledList,  ContentType bodyContentType,  String? body,  String? query,  List<FormDataModel>? formData,  String? bodyFile)  $default,) {final _that = this;
switch (_that) {
case _HttpRequestModel():
return $default(_that.method,_that.url,_that.headers,_that.params,_that.authModel,_that.isHeaderEnabledList,_that.isParamEnabledList,_that.bodyContentType,_that.body,_that.query,_that.formData,_that.bodyFile);case _:
  throw StateError('Unexpected subclass');
...
@override final  String? bodyFile;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _HttpRequestModel&&(identical(other.method, method) || other.method == method)&&(identical(other.url, url) || other.url == url)&&const DeepCollectionEquality().equals(other._headers, _headers)&&const DeepCollectionEquality().equals(other._params, _params)&&(identical(other.authModel, authModel) || other.authModel == authModel)&&const DeepCollectionEquality().equals(other._isHeaderEnabledList, _isHeaderEnabledList)&&const DeepCollectionEquality().equals(other._isParamEnabledList, _isParamEnabledList)&&(identical(other.bodyContentType, bodyContentType) || other.bodyContentType == bodyContentType)&&(identical(other.body, body) || other.body == body)&&(identical(other.query, query) || other.query == query)&&const DeepCollectionEquality().equals(other._formData, _formData)&&(identical(other.bodyFile, bodyFile) || other.bodyFile == bodyFile));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,method,url,const DeepCollectionEquality().hash(_headers),const DeepCollectionEquality().hash(_params),authModel,const DeepCollectionEquality().hash(_isHeaderEnabledList),const DeepCollectionEquality().hash(_isParamEnabledList),bodyContentType,body,query,const DeepCollectionEquality().hash(_formData),bodyFile);
