...
/// Resolves the workspace dir: `--workspace` override, else the desktop
/// app's configured folder, else the platform default data dir.
String resolveWorkspace(ArgResults? globalResults) {
  final override = globalResults?['workspace'] as String?;
  if (override != null && override.isNotEmpty) return override;
  return detectWorkspacePath() ?? getDefaultDataDir();
}
