...
- MacOS (Universal build - Apple Silicon & Intel) - [Download Link](https://github.com/foss42/api-dash/releases/download/v0.1.0/api_dash_macos.dmg) & [Installation Instructions](https://github.com/foss42/api-dash/blob/main/INSTALLATION.md#macos)
- Windows (64-bit) - [Download Link](https://github.com/foss42/api-dash/releases/download/v0.1.0/api_dash_windows_x64.exe) & [Installation Instructions](https://github.com/foss42/api-dash/blob/main/INSTALLATION.md#windows)
